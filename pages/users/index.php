                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <div>
                                                <select class="form-select" aria-label="Default select example" v-model="workgroup" @change="onChangeWorkgroupLists">
                                                <option v-for="item in workgroupLists" :value="item.value">{{item.text}}</option>
                                                </select>
                                            </div>
                                            ...
                                            <tbody>
                                                <tr v-for="d,index in datas">
                                                    ...
                                                    <th scope="row" @click="b_user_img(d.uid,index)">
                                                        <img :src="d.img" alt="Photo"  height="80">
                                                    </th>
                                                    <td>
                                                        <p>
                                                            ...
                                                            <br><i class="bi bi-telephone"></i> <span class="text-sm">{{d.phone}}</span> 
                                                        </p>
                                                    </td>
                                                    <td>
