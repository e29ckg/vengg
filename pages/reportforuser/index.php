        ...
        <div id="main">
            ...
            <div class="page-content" id="asuReport" v-cloak>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody v-for="vc in ven_coms">
                                                <tr v-if="vc.ven_month == cvg.ven_month">
                                                    <td>
                                                        เลขคำสั่งที่ {{vc.ven_com_num}} | ลงวันที่
                                                        {{vc.ven_com_date_th}} | {{vc.ven_com_name}} ({{vc.ven_name}})
                                                        <!-- | {{vc.ref}} | {{vc.status}} -->
                                                    ...
                                                    <td class="text-end col " style="width: 250px;">
                                                        ...
                                                        <button class="btn btn-primary btn-sm m-2"
                                                            @click="print(vc.id)">เอกสารแนบท้าย</button>
                                                        <button class="btn btn-primary btn-sm m-2"
                                                            @click="print2(vc.id)">สรุป1</button>
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                    data-bs-target="#view" ref="show_modal" hidden>
                    Open Modal
                </button>
