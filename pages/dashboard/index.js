Vue.createApp({
  ...
  methods: {
    ...
    async cal_click(id){
        ...
        this.isLoading = true;
        await axios.post('../../server/dashboard/get_ven.php',{id})
          .then(response => {
    ...
    getProfile(){
      // this.isLoading = true;
      axios.get('../../server/dashboard/get_profile.php')
      .then(response => {
          if (response.data.status) {
    ...
    get_vens(){
      this.isLoading = true;
      axios.get('../../server/dashboard/get_vens.php?month='+this.ven_month)
      .then(response => {
          if (response.data.status) {
    ...
    get_users(){
      axios.post('../../server/dashboard/get_users.php',{data_event:this.data_event})
      .then(response => {
          // console.log(response.data);
          if (response.data.status) {
    ...
    get_vens2(){
      // this.isLoading = true;
      axios.post('../../server/dashboard/get_vens2.php',{data_event:this.data_event})
      .then(response => {
          // console.log(response.data);
          if (response.data.status) {
    ...
    send_user_up(v,u){
      this.isLoading = true;
      axios.post('../../server/dashboard/change_save_b2.php',{v, u})
      .then(response => {
          if (response.data.status) {
            this.ch_a =false
            this.ch_b =false
    ...
    send_user_ck(data_event,my_ven){
      ...
      this.isLoading = true;
      axios.post('../../server/dashboard/change_save2.php',{ch_v1:this.ch_v1, ch_v2:this.ch_v2})
      .then(response => {
          if (response.data.status) {
            this.ch_a =false
            this.ch_b =false
    ...
    print(id){
      this.isLoading = true;
      axios.post('../../server/history/print2.php',{id})
      .then(response => {
          if (response.data.status) {
            // this.alert("success",response.data.message,timer=1000)
    ...
    async getUsersForChange(data_event){
      ...
      await axios.post('../../server/dashboard/get_users_for_change.php',{data_event:data_event})
      .then(response => {
            this.usersForChange = response.data.users
      })
      .catch(function (error) {
    ...
    async getUsersForChange2(id){
      await axios.post('../../server/dashboard/get_users_for_change2.php',{id:id})
      .then(response => {
